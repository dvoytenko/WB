...
/**
 */
var PanZoomEpisodeView = BaseEpisodeView.extend({
	
	className: "Episode PanZoomEpisode",
...
viewClassMap['PanZoomEpisode'] = PanZoomEpisodeView;

boardClassMap['PanZoomEpisode'] = BoardElementViewNone;
