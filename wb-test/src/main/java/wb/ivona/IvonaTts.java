...
public class IvonaTts {
	...
	public static void main(String[] args) throws Exception {
		...
		writer.write("&text=" + enc("Or may be you are a professor." +
				" And would like to explain a formula to a student."));
		writer.write("&contentType=" + enc("text/plain"));
		writer.write("&voiceId=en_us_jennifer");
		...
		FileOutputStream stream = new FileOutputStream("target/ivona-" + js.getString("fileId") + ".mp3");
		IoHelper.copy(url.openStream(), stream);
		stream.close();
